...
kable(rounded_matrix, format = "latex", escape = FALSE) %>%
  kable_styling(full_width = FALSE, font_size = 2) %>%
  scroll_box(width = "100%", height = "400px")

# kable(matrix_results, format = "latex", escape = FALSE) %>%
